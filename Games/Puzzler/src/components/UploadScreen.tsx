...
export function UploadScreen({ error, onImageReady, onError }: UploadScreenProps) {
  ...
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center gap-6 p-6 text-center">
      <h1 className="text-4xl font-bold text-pz-ink drop-shadow-sm">Puzzler</h1>
      ...
      <div
        ...
        className={`flex w-full max-w-md flex-col items-center gap-4 rounded-2xl border-4 border-dashed p-10 transition-colors ${
